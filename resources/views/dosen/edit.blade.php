            ...
            <section class="content">
                ...
                <div class="card card-primary">
                    ...
                    {{-- <form action="{{url('mahasiswa/{Npm}')}}/update" method="POST"> --}}
                        <form action="/dosen/{{ $dosen->Kd_dosen }}/update" method="POST">
                            {{csrf_field()}}
                            <div class=" card-body">
    
                            <div class="form-group">
                                <label for="#">Kode Dosen</label>
                                <input name="Kd_dosen" type="" class="form-control" id="#" placeholder="Enter Kode Dosen" value="{{ $dosen->Kd_dosen }}"  readonly>
                            </div>
    
                            <div class="form-group">
                                <label for="#">Nama Dosen</label>
                                <input name="nama" type="" class="form-control" id="#" value="{{ $dosen->nama }}"
                                    placeholder="Enter Nama Lengkap">
                            </div>
    
                            <div class="form-group">
                                <label for="#">Email</label>
                                <input name="email" type="" class="form-control" id="#" value="{{ $dosen->email }}" placeholder="Enter alamat">
                            </div>
    
                            <div class="form-group">
                                <label for="#">alamat</label>
                                <input name="alamat" type="" class="form-control" id="#" value="{{ $dosen->alamat }}"
                                    placeholder="Enter Alamat">
                            </div>
    
                            <div class="form-group">
                                <label for="#">Mata Kuliah</label>
                                <input name="jurusan" type="" class="form-control" id="#" value="{{ $dosen->jurusan }}"
                                    placeholder="Enter Jurusan">
                            </div>
                            <div class="form-group">
                                <label for="#">Prodi</label>
                                <input name="prodi" type="" class="form-control" id="#" value="{{ $dosen->prodi }}" placeholder="Enter Prodi">
                            </div>
                            <div class="form-group">
                                <label for="#">Masa Jabatan</label>
                                <input name="masa_jabatan" type="" class="form-control" id="#" value="{{ $dosen->masa_jabatan }}" placeholder="Enter Masa Jabatan">
                            </div>
