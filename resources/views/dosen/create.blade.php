                ...
                <div class="card card-primary">
                    ...
                    <form action="{{url('dosen/store')}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input name="Kd_dosen" type="" class="form-control" id="#" placeholder="Enter Kode Dosen">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="email" type="" class="form-control" id="#" placeholder="Enter alamat">
                        </div>

                        <div class="form-group">
                            <label for="#">alamat</label>
                            <input name="alamat" type="" class="form-control" id="#"
                                placeholder="Enter Alamat">
                        </div>

                        <div class="form-group">
                            <label for="#">Mata Kuliah</label>
                            <input name="jurusan" type="" class="form-control" id="#"
                                placeholder="Enter Jurusan">
                        </div>
                        <div class="form-group">
                            <label for="#">Prodi</label>
                            <input name="prodi" type="" class="form-control" id="#" placeholder="Enter Prodi">
                        </div>
                        <div class="form-group">
                            <label for="#">Masa Jabatan</label>
                            <input name="masa_jabatan" type="" class="form-control" id="#" placeholder="Enter Masa Jabatan">
                        </div>
